...
quote = "It is only when they go wrong that machines remind you how powerful they are. - Clive James"
add(quotes, BreakLines(quote))

quote = "The Web as I envisaged it, we have not seen it yet. The future is still so much bigger than the past. - Tim Berners Lee"
add(quotes, BreakLines(quote))

quote = "If it keeps up, man will atrophy all his limbs but the push-button finger. - Frank Lloyd Wright"
add(quotes, BreakLines(quote))

quote = "If future generations are to remember us more with gratitude than sorrow, we must achieve more than just the miracles of technology. We must also leave them a glimpse of the world as it was created, not just as it looked when we got through with it. - Lyndon B. Johnson"
add(quotes, BreakLines(quote))
...
quote = "They were all dead. The final gunshot was an exclamation mark to everything that had led to this point. I released my finger from the trigger. And then it was over. – Max Payne"
add(quotes, BreakLines(quote))

quote = "You were almost a Jill sandwich! – Resident Evil"
add(quotes, BreakLines(quote))

quote = "The sun went down with practiced bravado. Twilight crawled across the sky, laden with foreboding. I didn’t like the way the show started. But they had given me the best seat in the house. Front row center. – Max Payne"
add(quotes, BreakLines(quote))

quote = "It’s dangerous to go alone, take this!"
add(quotes, BreakLines(quote))

quote = "I raised you, and loved you, I’ve given you weapons, taught you techniques, endowed you with knowledge. There’s nothing more for me to give you. All that’s left for you to take in my life. - Snake Eater"
add(quotes, BreakLines(quote))

quote = "Thank you, Mario! But our Princess is in another castle! – Super Mario"
add(quotes, BreakLines(quote))

quote = "Dreams have a nasty habit of going bad when you’re not looking. – Max Payne"
add(quotes, BreakLines(quote))
